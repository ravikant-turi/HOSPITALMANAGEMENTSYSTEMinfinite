...
<body>
	...
	<div class="form-container">
		<h:form>
			...
			<h:inputText id="tests"
				value="#{medicationHistoryController.medicationHistory.tests}" />

			<h:outputLabel for="medicines" value="Medicines:" />
			<h:inputText id="medicines"
				value="#{medicationHistoryController.medicationHistory.medicines}" />

			
			<h:outputLabel for="patientId" value="patientId" />
			<h:inputText id="patientId"
				value="#{medicationHistoryController.medicationHistory.patient.patientId}" />
