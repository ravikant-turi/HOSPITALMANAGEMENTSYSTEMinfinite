...
public class PatientController {
	...
	public PatientController() {
		  patientdao = new PatientDaoImpl(); // <-- Make sure this is set
		    patient = new Patient();   
	}
    ...
    public String createPatient() {
    	System.out.println("createPatient() called");

        
        patientdao.createPatientData(patient);

        FacesContext.getCurrentInstance().addMessage(null,
            new FacesMessage(FacesMessage.SEVERITY_INFO, "Patient saved successfully!", null));
        return null;
